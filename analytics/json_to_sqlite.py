...
def migrate_analytics_data(json_file: Path, db: AnalyticsDatabase, dry_run: bool = False) -> dict:
    """
    ...
    """
    stats = {"sessions_migrated": 0, "user_stats_migrated": 0, "daily_stats_migrated": 0, "errors": []}
...
def migrate_error_analytics(json_file: Path, db: AnalyticsDatabase, dry_run: bool = False) -> dict:
    """
    ...
    Returns:
        Dictionary with migration statistics
    """
    stats = {"errors_migrated": 0, "errors": []}
...
def migrate_archived_data(archive_dir: Path, db: AnalyticsDatabase, dry_run: bool = False) -> dict:
    """
    ...
    Returns:
        Dictionary with migration statistics
    """
    stats = {"files_migrated": 0, "sessions_migrated": 0, "errors": []}
...
def main():
    ...
    parser.add_argument(
        "--data-dir", type=str, default="Data", help="Data directory containing JSON files (default: Data)"
    )
    parser.add_argument(
        "--db-path", type=str, default="Data/analytics.db", help="SQLite database path (default: Data/analytics.db)"
    )
    parser.add_argument("--dry-run", action="store_true", help="Simulate migration without writing to database")
    parser.add_argument("--skip-archives", action="store_true", help="Skip migrating archived monthly files")
